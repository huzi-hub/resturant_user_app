...
class PLannerList extends StatefulWidget {
  const PLannerList({Key? key}) : super(key: key);

  @override
  PLannerListState createState() => PLannerListState();
}

class PLannerListState extends State<PLannerList> {
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          if (snapshot.data!.size == 0) {
            return Center(child: Text('Verified Planners list is empty'));
          }
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => PLannerDetails(
