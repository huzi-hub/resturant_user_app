...
import 'package:user_app/PendingRestRequestDetails.dart';

class PendingRestRequest extends StatefulWidget {
  @override
  State<PendingRestRequest> createState() => _PendingRestRequestState();
}

class _PendingRestRequestState extends State<PendingRestRequest> {
              ...
              return InkWell(
                ...
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => PendingRestRequestDetails(
